...
Usage:
    # Fetch all 640 districts (~45-60 min, ~1.8 GB)
...
DISTRICT_COORDS = {
    ...
    "OD_DEOGAR": (21.5330, 84.7270), "OD_JHARSUG":(21.8543, 84.0074),
    "OD_ANGUL":  (20.8397, 85.0983), "OD_DHENKAN":(20.4500, 84.5840),
    "OD_KANDHAM":(20.4700, 83.1700), "OD_BOUDH":  (20.8380, 84.3360),
    "OD_NAYAGAR":(20.1260, 84.3000), "OD_KHURDA": (20.1820, 85.6160),
    "OD_JAGATSI":(19.9310, 84.3976), "OD_GAJAPAT":(18.8200, 84.1000),
    "OD_BARAGAH":(21.3295, 83.6073), "OD_SUBARNAR":(20.0594, 85.0948),
    "OD_BHADRAK":(21.0579, 86.4927),
    # West Bengal
    "WB_KOLKAT": (22.5726, 88.3639), "WB_MURSHID":(24.1822, 88.2701),
    "WB_BARDH":  (23.2324, 87.8615), "WB_MEDIPUR":(22.4248, 87.3199),
    "WB_HOOGHLY":(22.9000, 88.3900), "WB_HOWRAH": (22.5887, 88.2663),
    "WB_NORTH24":(22.7200, 88.5400), "WB_SOUTH24":(22.1500, 88.3500),
    "WB_NADIA":  (23.4652, 88.5502), "WB_JALP":   (26.5163, 88.7180),
    "WB_COOCH":  (26.3204, 89.4457), "WB_DARJEE": (27.0360, 88.2627),
    "WB_MALDA":  (25.0108, 88.1420), "WB_DINAJ_N":(25.6230, 88.6420),
    "WB_DINAJ_S":(25.3300, 88.6000), "WB_PURULIA":(23.3302, 86.3647),
    "WB_BANKUR": (23.2330, 87.0739), "WB_BISH":   (22.9989, 86.9928),
    "WB_JHARG":  (22.4520, 86.9924), "WB_BIRBHUM":(23.8876, 87.5300),
    # Jharkhand
    "JH_RANCHI": (23.3441, 85.3096), "JH_JAMSHED":(22.8046, 86.2029),
    "JH_DHANBAD":(23.7957, 86.4304), "JH_BOKARO": (23.6693, 85.9875),
    "JH_HAZARIB":(23.9921, 85.3636), "JH_GIRIDIH":(24.1881, 86.2994),
    "JH_DEOGHAR":(24.4830, 86.6940), "JH_DUMKA":  (24.2682, 87.2501),
    "JH_PAKUR":  (24.6365, 87.8441), "JH_GODDA":  (24.8282, 87.2103),
    "JH_SAHEBG": (25.2433, 87.6397), "JH_JAMTARA":(23.9608, 86.8048),
    "JH_SIMDEGA":(22.6063, 84.5027), "JH_WEST_SI":(22.1530, 84.4300),
    "JH_GUMLA":  (23.0448, 84.5393), "JH_GARWAH": (24.1552, 83.8090),
    "JH_PALAMAU":(23.9921, 84.0760), "JH_LATEHAR":(23.7440, 84.5054),
    "JH_CHAIBAS":(22.5555, 85.8050), "JH_SERAIKEL":(22.5853, 85.9371),
    "JH_EAST_SI":(22.9218, 85.4760), "JH_RAMGARH":(23.6300, 85.5200),
    "JH_KOUND":  (23.8600, 85.0000),
    # Assam
    "AS_GUWAHAT":(26.1445, 91.7362), "AS_DIBRUGAR":(27.4728, 94.9120),
    "AS_JORHAT": (26.7465, 94.2026), "AS_SILCHAR": (24.8333, 92.7789),
    "AS_NAGAON": (26.3483, 92.6850), "AS_KAMRUP":  (26.0700, 91.6000),
    "AS_SONITPUR":(26.6300, 92.8000),"AS_TINISUK": (27.4891, 95.3499),
    "AS_LAKHIMP":(27.2381, 94.1000), "AS_DHEMAJI": (27.4800, 94.5700),
    "AS_BONGAIG":(26.4771, 90.5584), "AS_KOKRAJ": (26.4000, 90.0200),
    "AS_UDALGUR":(26.7500, 90.8000), "AS_DHUBRI":  (26.0220, 89.9740),
    "AS_GOALPARA":(25.9840, 90.6260),"AS_BARPETA": (26.3190, 91.0040),
    "AS_NALBARI":(26.4440, 91.4380), "AS_MORIGAON":(26.2530, 92.3360),
    "AS_KARBI":  (25.9920, 93.0330), "AS_DIMA_HA":(25.5780, 93.0218),
    "AS_CACHAR": (24.8089, 92.8574), "AS_HAILAKAN":(24.3330, 92.6670),
    "AS_KARIMGJ":(24.8650, 92.3610),
    # Himachal Pradesh
    ...
    "HP_LAHUL":  (32.5600, 77.4000), "HP_CHAMBA": (32.5519, 76.1249),
    # Uttarakhand
    "UK_DEHRAD": (30.3165, 78.0322), "UK_HARIDWAR":(29.9457, 78.1642),
    "UK_NAINITAL":(29.3909, 79.4570),"UK_UDHAM":  (28.9738, 79.5117),
    "UK_ALMORA": (29.5892, 79.6467), "UK_CHAMPAW":(29.3356, 80.0907),
    "UK_PITHOR": (29.5820, 80.2080), "UK_BAGESH": (29.8370, 79.7700),
    "UK_CHAMOLI":(30.4000, 79.3200), "UK_RUDRAP": (30.2899, 78.9763),
    "UK_TEHRI":  (30.3781, 78.4804), "UK_UTTARKSH":(30.6929, 78.4305),
    "UK_PAURI":  (29.8633, 78.8547),
    # Delhi
    "DL_NEW_DL": (28.6139, 77.2090),
    # Goa
    "GA_NORTH":  (15.4909, 73.8278), "GA_SOUTH":  (15.2993, 74.1240),
    # Northeast states (key districts)
    "MN_IMPHAL": (24.8170, 93.9368), "MI_SHILLONG":(25.5788, 91.8933),
    "NL_KOHIMA": (25.6747, 94.1086), "TR_AGARTALA":(23.8315, 91.2868),
    "AR_ITANAG": (27.0844, 93.6053), "SK_GANGTOK":(27.3314, 88.6138),
    "MZ_AIZAWL": (23.7271, 92.7176),
    # Jammu & Kashmir / Ladakh
    "JK_SRINAGGR":(34.0837, 74.7973),"JK_JAMMU":  (32.7266, 74.8570),
    "JK_ANANTNAG":(33.7311, 75.1487),"JK_BARAMULL":(34.1992, 74.3629),
    "LD_LEH":    (34.1526, 77.5771),
}
